...
public class UploadYoga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addImg = findViewById(R.id.Yogaimg);
        addimagesview = findViewById(R.id.Yogaimgview);
        noticetitle = findViewById(R.id.Yogatitle);
        uploadphotosbutton = findViewById(R.id.yogaImgBtn);
    ...
    private void uploadImage() {
        ...
        uploadTask.addOnCompleteListener(UploadYoga.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    pd.dismiss();
                    Toast.makeText(UploadYoga.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                }
    ...
    private void uploadData() {
        ...
        reference.child(uniquekey).setValue(photosData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                pd.dismiss();
                Toast.makeText(UploadYoga.this, "Photo Uploaded", Toast.LENGTH_SHORT).show();
