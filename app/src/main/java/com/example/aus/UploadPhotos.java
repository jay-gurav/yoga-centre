...
public class UploadPhotos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addImg=findViewById(R.id.upload_photos);
        addimagesview=findViewById(R.id.addimgview);
        noticetitle=findViewById(R.id.addTitle);
        uploadphotosbutton=findViewById(R.id.uploadImgBtn);
    ...
    private void uploadImage() {
        ...
        uploadTask.addOnCompleteListener(UploadPhotos.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    pd.dismiss();
                    Toast.makeText(UploadPhotos.this,"Something Went Wrong",Toast.LENGTH_SHORT).show();
                }
    ...
    private void uploadData() {
        ...
        reference.child(uniquekey).setValue(photosData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                pd.dismiss();
                Toast.makeText(UploadPhotos.this, "Photo Uploaded", Toast.LENGTH_SHORT).show();
